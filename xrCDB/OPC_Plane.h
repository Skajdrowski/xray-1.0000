...
#define __ICEPLANE_H__
	...
	class ICEMATHS_API Plane
	{
		...
		inline_	Plane&	Set(float nx, float ny, float nz, float _d)						{ n.Set(nx, ny, nz); this->d = _d;	return *this;	}
		inline_	Plane&	Set(const Point& p, const Point& _n)								{ this->n = _n; d = - p | _n;			return *this;	}
