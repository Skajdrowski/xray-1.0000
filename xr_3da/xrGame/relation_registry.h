//////////////////////////////////////////////////////////////////////////
// relation_registry.h: реестр дл¤ хранени¤ данных об отношении персонажа к 
//						другим персонажам
//////////////////////////////////////////////////////////////////////////
...
public:
	...
	//список действий актера, за которые начисл¤ютс¤
	//очки рейтинга, репутации или мен¤етс¤ отношени¤ персонажа
	//к группировке
